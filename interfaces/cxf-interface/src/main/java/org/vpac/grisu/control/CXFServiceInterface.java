...
public interface CXFServiceInterface extends ServiceInterface {
	...
	//
	//	/**
	//	 * Returns a list of all multipart job ids that are currently stored on this
	//	 * backend
	//	 *
	...
	//	 */
	//	@WebMethod
	//	String getJobProperty(String jobname, String key) throws NoSuchJobException;
	//
	//	/**
	...
	//	 */
	//	@WebMethod
	//	void kill(String jobname, boolean clean) throws RemoteFileSystemException,
	...
	//	// * {@link JobSubmissionProperty}. If not all required job properties can
	//	// be
